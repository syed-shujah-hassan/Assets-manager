    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.statusCard}>
        <View style={styles.statusLeft}>
          ...
          <Text style={styles.statusLine}>Live map is available in the mobile app.</Text>
        </View>
      ...
      <View style={styles.mapCard}>
        <View style={styles.mapHeader}>
          ...
          <Text style={styles.mapHint}>Web preview doesn’t support native maps.</Text>
        </View>

        <View style={styles.mapPlaceholder}>
          <View style={styles.mapFallback}>
            <Ionicons name="map-outline" size={32} color={Colors.textMuted} />
            <Text style={styles.mapFallbackText}>Open this screen on Android/iOS to view the live map.</Text>
          </View>
          ...
          <View style={styles.mapFooter}>
            {typeof incidentLat === 'number' && typeof incidentLng === 'number' ? (
              ...
              <Text style={styles.coordsText}>{hasCoordinates ? 'Loading…' : 'Using request location.'}</Text>
            )}
          </View>
        </View>
      </View>
      ...
      <Text style={styles.webNote}>Platform: {Platform.OS}</Text>
    </ScrollView>
  );
}
...
const styles = StyleSheet.create({
  ...
  mapFallbackText: { fontSize: 13, fontFamily: 'Inter_400Regular', color: Colors.textMuted, textAlign: 'center', paddingHorizontal: 16 },
  mapFooter: {
    height: 32,
  ...
  webNote: { marginTop: 12, fontSize: 12, fontFamily: 'Inter_400Regular', color: Colors.textMuted, textAlign: 'center' },
});
